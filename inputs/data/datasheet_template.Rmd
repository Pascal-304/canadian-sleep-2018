...
author: 
  - Pascal Lee Slew
thanks: "Code and data are available at: https://github.com/Pascal-304/canadian-sleep-2018/tree/main/inputs/data."
...
4. *Will the dataset be updated (for example, to correct labeling errors, add new instances, delete instances)? If so, please describe how often, by whom, and how updates will be communicated to dataset consumers (for example, mailing list, GitHub)?*
	- If there is any error made in the creation of the dataset, it will be updated by Pascal Lee Slew. Any updates will be communicated as a note in the Readme file at the link below:
