...
# Author: Pascal Lee Slew [CHANGE THIS TO YOUR NAME!!!!]
# Data: 29 April 2022
...
raw_data <- read_csv("  .csv")
dict <- read_lines(" _dict.txt", skip = number ) # skip is because of preamble content
# Now we need the labels because these are the actual responses that we need
labels_raw <- read_file("  _labels.txt")
